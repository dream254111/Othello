...
//                System.out.println("Move: " + move);
                ...
                if (legalMoves.size() == 0) {
                    ...
                    if (legalMoves.size() == 0) {
                        ...
                        sb.append("Game Over");
                        over = true;
//                        System.out.println("By Dream: White = " + OthelloGame.computeScore(curBoard, OthelloGame.W));
//                        System.out.println("By Dream: Black = " + OthelloGame.computeScore(curBoard, OthelloGame.B));
                    }
//                    System.out.println(sb.toString());
//                    System.out.println("By Dream: White = " + OthelloGame.computeScore(curBoard, OthelloGame.W));
//                    System.out.println("By Dream: Black = " + OthelloGame.computeScore(curBoard, OthelloGame.B));
